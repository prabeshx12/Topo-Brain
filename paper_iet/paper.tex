...
\usepackage{xcolor}
\usepackage{abstract}
\usepackage{orcidlink}     % \orcidlink{0000-0000-0000-0000} renders the iD glyph
\usepackage{lineno}        % line numbers for reviewer convenience
% \linenumbers              % uncomment for review submission; comment for camera-ready
...
\author[1]{Prabesh Bashyal\,\orcidlink{0000-0000-0000-0000}}
\author[1]{Pratik Adhikari\,\orcidlink{0000-0000-0000-0000}}
\author[1]{Spandan Bhandari\,\orcidlink{0000-0000-0000-0000}}
\author[1,*]{Nanda Bikram Adhikari\,\orcidlink{0000-0000-0000-0000}}
...
\affil[*]{Corresponding author: \texttt{adhikari@ioe.edu.np}. Replace the four 0000-0000-0000-0000 placeholders with each author's ORCID iD before submission.}
\date{}
...
$d=+0.68$ (medium effect). We present an end-to-end pipeline
...
(Fig.~\ref{fig:adrisk}). This is below the 3T-baseline composite (AUC
...
$d=+0.68$. We have implemented and self-validated an end-to-end
...
support; and E.K.\ Solutions for providing access to NVIDIA A100 GPU
resources without which this work would not have been possible.
...
This work received no direct external funding. Computational
resources (NVIDIA A100 GPU access) were provided in-kind by E.K.\
Solutions. Data collection and sharing for the Alzheimer's Disease
