"""Build a POSIX-safe code bundle zip for the Kaggle eval kernel."""
import zipfile
...
with zipfile.ZipFile(OUT, "w", zipfile.ZIP_DEFLATED) as z:
    ...
    # empty inits so `src.diffusion` imports without pulling in monai
    z.writestr("src/__init__.py", "# minimal init for Kaggle eval (avoids monai import)\n")
